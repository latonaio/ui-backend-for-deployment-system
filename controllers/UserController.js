...
const Users = require('../models/Deployment/Users.js');

const {_, validationResult} = require('express-validator/check');
...
module.exports = {
  authenticate: function (req, res) {
    ...
    Users.getUsers().then((users) => {
      const result = users.filter(user => user.user_name === req.body.email);
